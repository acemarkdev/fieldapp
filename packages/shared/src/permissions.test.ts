...
for (const cap of ['jobs.manage', 'items.create', 'items.edit', 'items.fit', 'snags.raise', 'qa.signoff', 'photos.add', 'teams.manage', 'monday.sync', 'users.manage', 'customers.manage', 'dashboard.view'] as const) {
